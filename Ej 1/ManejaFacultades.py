...
class ManejadorFacultades:
    ...
    def CargaLista(self):
        archivo = open('Facultad.csv', encoding='utf8')
    ...
    def Mostrar(self, carrera, codigo, i):
        print("Nombre carrera: {}, Codigo: {}, Nombre de Facultad: {}, Direccion de la Facultad: {}".format(
            carrera.getNom(), codigo, self.__lista[i].getNom(), self.__lista[i].getDireccion()
        ))
